<?
	...
	// Email content
	$e_subject = 'New message from DonCullen.net';
	...
	if(mail($address, $e_subject, $msg, $headers)) {
		...
		echo "<h4 class='highlight'>Thanks, <strong>$name</strong>, your message has been sent to Don!</h4>";
		echo "</div>";
	} else {
		echo 'ERROR!';
	}
